"""Environmental sensing integration for adaptive 3D printing control.

This module provides environmental monitoring and adaptive control systems
...
class EnvironmentalSensorManager:
    """Manages environmental sensors and data collection."""
...
class AdaptivePrintController:
    ...
    def __init__(self, sensor_manager: EnvironmentalSensorManager):
